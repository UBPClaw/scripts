# Script to Update Mitchell1.com Internal DNS when Hosting is running out of San Jose
# If sites are missing they need to be added to $InputFile 

# Environment Setup 
$DNSServer = "charger"
$ZoneName = "mitchell1.com"
$InputFile = "\\malibu\it\Scripts\Powershell\Mitchell1_Hosting_DNS_Updates\sjos_dnsrecords.csv" 
