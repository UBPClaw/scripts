...
#remove-Item C:\Workdir\Meps\GraphicsDept\GraphicsDeptUID.txt
$group = [adsi] "LDAP://cn=Graphics Dept,cn=distribution lists,cn=users,dc=corp,dc=mitchellrepair,dc=com" 
...
$user.get("SAMACCOUNTNAME")| Out-File C:\Workdir\Meps\Graphicsdept\GraphicsDeptUID.txt -Append -encoding ASCII
