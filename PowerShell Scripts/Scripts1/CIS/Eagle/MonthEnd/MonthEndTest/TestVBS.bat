@echo off
cls
net use b: \\dakota\apps
del b:\cis\monthend\monthend.txt 
rem *****************
rem * Get Date/Time *
rem *****************
...
rem ******************
echo Sending email...
set SendTo1=8586352690@alphapage.myairmail.com,bryan.debrun@mitchell1.com,vickie.clemons@mitchell1.com
set SendFrom1=%computername%.mitchellrepair.com
set SMTPServer1=smtp.mitchellrepair.com
set subject1="Month End Test"
set body1="THIS IS A TEST!"
