...
REM************************************************************************************************
REM                    SYNCH THE BEFORE VOLUME FROM XLR TO EAGLE
REM************************************************************************************************
cls
rem *****************
rem * Get Date/Time *
...
echo Deporting Disk Group on Remote host>>C:\Resync_SnapShot_Before.log
echo ***********************************>>C:\Resync_SnapShot_Before.log
psexec \\xlr vxdg -g CIS_Before -f deport>>C:\Resync_SnapShot_Before.log
echo.>>C:\Resync_SnapShot_Before.log
echo.>>C:\Resync_SnapShot_Before.log
...
set SMTPServer1=smtp.mitchellrepair.com,8586352690@alphapage.myairmail.com,8586352534@myairmail.com
