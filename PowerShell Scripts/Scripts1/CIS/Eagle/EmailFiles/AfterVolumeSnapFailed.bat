...
set subject1="FAIL! THE AFTER VOLUME DID NOT SNAP"
set body1="FAIL! THE AFTER VOLUME DID NOT SNAP. Please hold all day end processes until Notified by a Sys Admin."
