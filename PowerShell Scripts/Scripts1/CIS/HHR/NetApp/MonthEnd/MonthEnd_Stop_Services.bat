...
:END
REM This script stops the above services, calls E:\Scripts\NetApp\MonthEnd\MonthEnd_Create_SnapShot_After.cmd
REM and then exits

call E:\Scripts\NetApp\MonthEnd\MonthEnd_Create_SnapShot_After.cmd
