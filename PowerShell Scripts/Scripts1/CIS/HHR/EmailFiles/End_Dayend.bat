...
rem ******************
echo Sending email...
set SendTo1=dataadmin@mitchell1.com,Gail.Smolen@mitchell1.com
set SendFrom1=%computername%.mitchellrepair.com
set SMTPServer1=smtp.mitchellrepair.com
set subject1="The After volume has snapped!"
set body1="Both Before and After volumes are ready for backup"
...
del \\dakota\apps\CIS\Dayend\BEGINDAYEND.TXT
echo Continue Day End>\\dakota\apps\CIS\Dayend\SNAPCOMPLETE.TXT