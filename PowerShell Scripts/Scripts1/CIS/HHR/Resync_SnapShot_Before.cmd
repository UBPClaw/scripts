...
REM************************************************************************************************
REM                    SYNCH THE BEFORE VOLUME FROM HHR TO EAGLE
REM************************************************************************************************
cls
rem *****************
rem * Get Date/Time *
...
echo %today%>E:\scripts\Resync_SnapShot_Before.log
echo.>>E:\scripts\Resync_SnapShot_Before.log
...
echo Deporting Disk Group on Remote host>>E:\scripts\Resync_SnapShot_Before.log
echo ***********************************>>E:\scripts\Resync_SnapShot_Before.log
vxdg -g CIS_Before -f deport>>E:\scripts\Resync_SnapShot_Before.log
echo.>>E:\scripts\Resync_SnapShot_Before.log
echo.>>E:\scripts\Resync_SnapShot_Before.log
...
echo Resyncing with Production Disk>>E:\scripts\Resync_SnapShot_Before.log
echo ***********************************>>E:\scripts\Resync_SnapShot_Before.log
pairresync -g CIS_Before -c 15>>E:\scripts\Resync_SnapShot_Before.log
...
set body1=E:\scripts\Resync_SnapShot_Before.log
