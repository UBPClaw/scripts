...
rem ************************************
rem Disabled 8-20-09 Moved to CreateSnapshot_Before to prevent magnum
rem from doing a robocopy if dayend runs late
rem psexec \\gremlin vxdg -g CIS_After -f deport

rem ###################################################################
rem # Command set for offlining LUN's from AFTER host
rem ###################################################################

rsh M45 lun offline /vol/cis_clone_after/lun0.lun>>E:\scripts\Create_SnapShot_After.log
sleep 5
...
rsh M45 lun unmap /vol/cis_clone_after/lun0.lun gremlin>>E:\scripts\Create_SnapShot_After.log
sleep 5
...
rsh M45 vol offline cis_clone_after>>E:\scripts\Create_SnapShot_After.log
rsh M45 vol destroy cis_clone_after -f>>E:\scripts\Create_SnapShot_After.log
sleep 5
...
rsh M45 snap delete cis_fc cis_after.6>>E:\scripts\Create_SnapShot_After.log
rsh M45 snap rename cis_fc cis_after.5 cis_after.6>>E:\scripts\Create_SnapShot_After.log
rsh M45 snap rename cis_fc cis_after.4 cis_after.5>>E:\scripts\Create_SnapShot_After.log
rsh M45 snap rename cis_fc cis_after.3 cis_after.4>>E:\scripts\Create_SnapShot_After.log
rsh M45 snap rename cis_fc cis_after.2 cis_after.3>>E:\scripts\Create_SnapShot_After.log
rsh M45 snap rename cis_fc cis_after.1 cis_after.2>>E:\scripts\Create_SnapShot_After.log
rsh M45 snap rename cis_fc cis_after.0 cis_after.1>>E:\scripts\Create_SnapShot_After.log
rsh M45 snap create cis_fc cis_after.0>>E:\scripts\Create_SnapShot_After.log
sleep 5
...
rsh M45 vol clone create cis_clone_after -b cis_fc cis_after.0>>E:\scripts\Create_SnapShot_After.log
sleep 5
