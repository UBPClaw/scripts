...
rem ******************
echo Sending email...
set SendTo1=administrator@mitchell1.com,DayEndPaging@MitchellRepair.com
set SendFrom1=%computername%.mitchellrepair.com
set SMTPServer1=smtp.mitchellrepair.com
set subject1="Month End Test *** Please Respond to administrator@mitchell1.com"
set body1="Month End Test *** Please Respond to administrator@mitchell1.com."
