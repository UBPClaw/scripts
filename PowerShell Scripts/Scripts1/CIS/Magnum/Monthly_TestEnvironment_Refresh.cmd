...
set destination1=F:\UV\Accounts\Mitchell1\CISPUB83.TEST
set destination2=F:\UV\accounts\Mitchell1\CISPRG8.TEST
set logfile=MonthlyTestEnv_Refresh
...
set BodyFail1="The '%~0' script did not run on %computername%. The '%source1%'and or '%source2%'  path does not exist."
...
E:\progra~1\ibm\uv\bin\uvsh BeforeRestore.TEST
...
E:\progra~1\ibm\uv\bin\uvsh AfterRestore.TEST


call \\dakota\apps\cistest\dayendemail\autorestore.bat
...
cls
echo.
echo The destination folder '%destination2%' must be be present for this script to run!
echo.
pause
goto end
