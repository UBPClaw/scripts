...
rem ****************************
set source1=\\gremlin\U$\UV
set destination1=W:\UV
set logfile=After_Day_End_Copy
...
rem * Start Robocopy *
rem ******************
robocopy %source1% %destination1% /MIR /COPY:DAT /R:2 /W:5 /NP /XD W:\UV\accounts\Mitchell1\CIS.TEST /S /LOG:C:\Scripts\%logfile%.log /TEE
