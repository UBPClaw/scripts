...
set logfile=Restore_AfteterSnap_TO_F_Drive_On_Magnum
...
rem * Start Robocopy *
rem ******************
robocopy %source1% %destination1% /MIR /COPY:DAT /R:2 /W:5 /NP /XF D_* SELOG SEWK SECURITY SEAUDIT RPTDEFS.USER RPTHDRS.USER /XD F:\UV\accounts\Mitchell1\CIS.TEST /S  F:\UV\accounts\Mitchell1\CIS.TEST.PRG /S /LOG:C:\Scripts\%logfile%.log /TEE
