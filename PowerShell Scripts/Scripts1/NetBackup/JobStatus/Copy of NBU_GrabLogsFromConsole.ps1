...
# The split method allows us to grab data at a specific comma.
 ...
 gc D:\BKD_LOGS\NBULOGS\NbuTempLogs.txt | Where-Object {$_.split(",")[8] -match $BupDt -and $_.split(",")[11] -ne "0"-and $_.split(",")[14] -lt "2" } | Out-File D:\BKD_LOGS\NBULOGS\NBULogsToSQL_$FileDate.txt -append
