...
$header = "Policy,Client,BUPID,ClientType,SchedLbl,SchedType,Retention,BupDate,BupTime,TimeTaken,ExpireDate,ExpireTime,BupDateEnd,BupTimeEnd,KBS,CopyCount"| Out-File D:\BKD_LOGS\JobStatus\WIP\bpimagelist.csv -append
...
# Output the results to a CSV file.								
					$PolicyNm + "," + $Client + "," + $BUPID + "," + $ClientType + "," + $SchedLbl + "," + $SchedType + "," + $Retention + "," + $DateConv + "," + $TimeConv + "," + $ElpsdTime + "," + $ExpDateConv + "," + $ExpTimeConv + "," + $BupDateComplete + "," + $BupTimeComplete + "," + $KBS + "," + $copy | Out-File D:\BKD_LOGS\JobStatus\WIP\bpimagelist.csv -append
...
foreach ($File in $Gfile)
	...
	#Import-Csv D:\BKD_LOGS\JobStatus\WIP\Report.csv | export-csv D:\BKD_LOGS\JobStatus\Report\Report.csv -notype
