...
$header = "Policy,Client,BUPID,ClientType,SchedLbl,SchedType,Retention,BupDate,ExpireDate,BupDateEnd,KBS,CopyCount"| Out-File c:\Test\bpimagelist.csv -append
...
# Output the results to a CSV file.								
					$PolicyNm + "," + $Client + "," + $BUPID + "," + $ClientType + "," + $SchedLbl + "," + $SchedType + "," + $Retention + "," + $DateConv + "," + $ExpDateConv + "," + $BupDateComplete + "," + $KBS + "," + $copy | Out-File c:\Test\bpimagelist.csv -append
...
# reporting. We import the existing file and export it to a new file.
	...
	Import-Csv c:\Test\bpimagelist.csv | export-csv c:\test\BUPREPORTS_$FileDate.csv -notype
