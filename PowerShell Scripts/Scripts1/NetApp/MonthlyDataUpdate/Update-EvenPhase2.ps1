...
#*******************************************************************************
# Phase 2 for Even Monthly Data Update
...
Set-NaVolSize ranger_dp_even 420g -Controller $m45 

# If volume is not already assigned to the vfiler remove # from the next line
Set-NaVfilerStorage ranger -AddStorage ranger_dp_even -Controller $m45
...
add-NaCifsShare Data_Next /vol/ranger_dp_even/dp/DataProcess/Data -comment "$Date" -controller $ranger
...
Remove-NaSnapshot ranger_dp_fc ranger_dp_even -Controller $m45 -Confirm:$false

# -- WAIT: (Til data has been approved by QA/Editoral)
write-host "Phase 2 complete. Dont foget to check Data_Next mount on Anglia" 