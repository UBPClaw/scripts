...
#*******************************************************************************
# Phase 1 for Even Monthly Data Update
...
# Rename the either ranger_dp_even to ranger_dp_previous
#Rename-NaVol ranger_dp_even ranger_dp_previous -Controller $m45
...
# Offline and Delete volume ranger_dp_even in FilerView on M45
Set-NaVol ranger_dp_even -Controller $m45 -Offline | Remove-NaVol -Confirm:$false 

# Create Snapshot off of ranger_dp_fc
New-NaSnapshot ranger_dp_fc ranger_dp_even -Controller $m45

# Create Flexclone using the snapshot ranger_dp_even
New-NaVolClone -ParentVolume ranger_dp_fc  -CloneVolume ranger_dp_even  -ParentSnapshot ranger_dp_even -SpaceReserve none -Controller $m45

# Split Flexclone 
Start-NaVolCloneSplit ranger_dp_even -Controller $m45 

# -- WAIT: (Takes about 16 hours, to check status connect to m45 and run "Get-NaVolCloneSplit ranger_dp_even -Controller $m45")
