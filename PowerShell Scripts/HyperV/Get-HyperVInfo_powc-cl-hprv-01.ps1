...
$log = "\\malibu\it\VirtualEnvironments\HyperV\VMs2012_powc-cl-hprv-01_"+(Time-Stamp)+".csv"
$log2 = "\\malibu\it\VirtualEnvironments\HyperV\Hosts2012_powc-cl-hprv-01_"+(Time-Stamp)+".csv"
...
param (
	...
	$report = @()
	$Cluster = Get-SCVMHostCluster -Name "powc-cl-hprv-01" -vmmserver powc-scvm-02-pv
