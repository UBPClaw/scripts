...
$log = "\\malibu\it\VirtualEnvironments\HyperV\VMs2012_hyperv_corp_01_"+(Time-Stamp)+".csv"
$log2 = "\\malibu\it\VirtualEnvironments\HyperV\Hosts2012_hyperv_corp_01_"+(Time-Stamp)+".csv"
...
param (
	...
	$report = @()
	$Cluster = Get-SCVMHostCluster -Name "hyperv_corp_01" -vmmserver powc-scvm-02-pv
