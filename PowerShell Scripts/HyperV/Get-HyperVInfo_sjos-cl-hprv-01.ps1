...
$log = "\\malibu\it\VirtualEnvironments\HyperV\VMs2012_sjos-cl-hprv-01_"+(Time-Stamp)+".csv"
$log2 = "\\malibu\it\VirtualEnvironments\HyperV\Hosts2012_sjos-cl-hprv-01_"+(Time-Stamp)+".csv"
...
param (
	...
	$report = @()
	$Cluster = Get-SCVMHostCluster -Name "sjos-cl-hprv-01" -vmmserver powc-scvm-02-pv
