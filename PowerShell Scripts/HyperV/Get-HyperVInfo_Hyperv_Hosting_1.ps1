...
$log = "\\malibu\it\VirtualEnvironments\HyperV\VMs2012_Hyperv_Hosting_1_"+(Time-Stamp)+".csv"
$log2 = "\\malibu\it\VirtualEnvironments\HyperV\Hosts2012_Hyperv_Hosting_1_"+(Time-Stamp)+".csv"
...
param (
	...
	$report = @()
	$Cluster = Get-SCVMHostCluster -Name "Hyperv_Hosting_1" -vmmserver powc-scvm-02-pv
